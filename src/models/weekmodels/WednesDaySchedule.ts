...
export class WednesDaySchedule {
    ...
    public setTuesday = (
        ...
        for (let i: number = 0; i < schedulePersonList.length; i++) {
            ...
            // 稼働上限になったので、リターン
            if (this.wednes_workTime1 >= OPERATION_PEOPLE_MAX) {
                break;
            }
            // 10= time >=14
            if (
        ...
        for (let i: number = 0; i < schedulePersonList.length; i++) {
            ...
            // 稼働上限になったので、リターン
            if (this.wednes_workTime2 >= OPERATION_PEOPLE_MAX) {
                break;
            }
            // 10 <= time >=14
            if (
        ...
        for (let i: number = 0; i < schedulePersonList.length; i++) {
            ...
            // 稼働上限になったので、リターン
            if (this.wednes_workTime3 >= OPERATION_PEOPLE_MAX) {
                break;
            }
            // 10 <= time >=23
            if (
